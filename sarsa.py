...
def sarsa_training(gym, environment, seed, training_episodes, gamma, eps_min=0.05, eps_max=1, eps_decay=5e-5, lr_min=0.05, lr_max=1, lr_decay=5e-5):
    ...
    for episode in range(training_episodes):
        ...
        for i in count():
            ...
            if terminated:
                ...
                next_action = tabular_epsilon_greedy(q_table, next_state, epsilon, env.action_space.n)
